...
$file = $_FILES['avatar']['type']; //returns the mimetype
...
$_SESSION['error'] ='Email Already Exist ';
 ...
 //Add User details
$sql = 'INSERT INTO accounts(type,email,password,name,photo) VALUES(:type,:email,:password,:name,:photo)';
...
<head>
  ...
  <title>New Teacher - <?php echo $sitename; ?></title>
        ...
        <div class="row">
		 ...
		 <!-- general form elements -->
              ...
              <form  action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtfullname" id="exampleInputName" size="77" value="<?php if (isset($_POST['txtfullname']))?><?php echo $_POST['txtfullname']; ?>" placeholder="Enter Fullname">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email </label>
                    <input type="text" class="form-control" name="txtemail" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtemail']))?><?php echo $_POST['txtemail']; ?>" placeholder="Enter Email">
                  </div>
                  <div class="form-group">
           ...
           <div class="form-group">
                    ...
                    <p class="text-center">
                   <img src="../<?php echo $user_photo; ?>" alt="Teacher image" width="178" height="154" id="logo-img">
				    </p>
              </div>
