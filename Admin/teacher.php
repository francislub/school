...
<head>
  ...
  <title>Teacher's Record|<?php echo $sitename; ?></title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Teacher's Record</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <tr>
              <td width="1090" height="184"><div class="card">
                ...
                <div class="card-footer">
                  <a class="btn btn-primary" href="add-teacher.php">Add Teacher</a>
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped custom-table" id="example1">
                    <thead>
                    <th ><div align="center"><span class="style1">id</span></div></th>
                    <th><div align="center"><span class="style1">photo</span></div></th>
                    <th><div align="center"><span class="style1">Type</span></div></th>
                    ...
                    <tbody>
                    <?php
                  $data = $dbh->query("SELECT *  FROM accounts")->fetchAll();
                  $cnt=1;
                  foreach ($data as $row) {
                    ?>
                      <tr class="gradeX">
                      ...
                      <td><div align="center" class="style2"><span class="controls"><img src="../<?php echo $row['photo'];?>"  width="50" height="43" border="2"/></span></div></td>
                        <td><div align="center" class="style2"><?php echo $row['type'];  ?></div></td>
                        <td><div align="center" class="style2"><?php echo $row['name'];  ?></div></td>
                        <td><div align="center" class="style2"><?php echo $row['email'];  ?></div></td>
			                   <td>
                         <div class="row">
                          <div class="col-6" align="center">
                                <a href='edit_teacher.php?id=<?php echo $row["id"]; ?>' class='btn btn-primary' style='margin-right: 5px;'><i class='fa fa-edit'></i> Edit</a>
                              </div>
                            <div class="col-6" align="center">
