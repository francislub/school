...
$sql = " update accounts set name='$name',email='$email',type='$type' where email='$email'";
if (mysqli_query($conn, $sql)) {

header( "refresh:2;url= edit_teacher.php" );
$_SESSION['success'] ='Teacher Edited Successfully';
}else{
...
<head>
  ...
  <title> Edit Teacher|<?php echo $sitename; ?></title>
             ...
             <form  action="" method="POST">
                <div class="card-body">
                   ...
                   <label>Fullname</label>
                      <input id="exampleInputName" name="txtfullname" type="text" size="77" value="<?php echo htmlspecialchars(isset($_POST['txtfullname']) ? $_POST['txtfullname'] : $row['name']); ?>" class="form-control required">
 
                     </div>
                         <div class="form-group">
                          <label>Email</label>
                         <input id="confirm" name="txtemail" type="text" size="77" value="<?php echo $row['email'];?>" class="form-control required">
                         </div>
